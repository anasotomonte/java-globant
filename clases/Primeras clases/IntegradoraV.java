...
System.out.println("La cantidad de caracteres dentro de la oración es igual a: " + longitud);
myScanner.nextLine();
...
System.out.println("La cantidad de palabras dentro de la oración es: " + cantidadDePalabras);
}
}
...
// String palabra: Cada elemento de ordenAlfa (que es una colección de String)
// se asignará a la variable palabra en cada iteración.
// : ordenAlfa: Significa que el bucle recorrerá todos los elementos dentro de
...
System.out.println("Ingrese un número para buscar la palabra ubicada en esa posición:");
int buscar2 = myScanner.nextInt();
String[] palabras = oracion.split(" ");
// Dividimos oracion en palabras y verificamos que buscar2 esté dentro del rango
// antes de acceder al arreglo palabras.1
if (buscar2 >= 0 && buscar2 < palabras.length) {
System.out.println("La palabra en la posición " + buscar2 + " es: " + palabras[buscar2]);
} else {
...
if (encontrado) {
System.out.println("La palabra :" + buscar + " se encuentra dentro de la cadena");
} else {
System.out.println("La palabra :" + buscar + " no se encuentra dentro de la cadena");
}
...
System.out.println("La palabra \"" + cambiar + "\" no se encuentra en la oración.");
}
}
}
